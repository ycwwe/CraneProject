...
public class ComLink implements ComlinkInterface{
	...
	public ComLink() {
      /*  System.out.println("初始化方法被调用");
		this.connectThread = new Thread(new Runnable() {
			public void run() {
				ComLink.this.doConnectThreadWork();
			}
		});
	...
	public ComLink(String clientAddress, int clientPort) {
...
//		}
	...
	public void startWriteThread() {
		...
		this.writeThread = new Thread(new Runnable() {
			public void run() {
				ComLink.this.doWriteThreadWork();
			}
		});
